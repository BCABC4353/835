...
_DATE_FIELD_PATTERNS = frozenset(["INTERCHANGEDATE", "DATE_ENVELOPE_GS", "PAYMENTDATE", "EFFECTIVEDATE"])
...
def redact_csv_row(row):
    name_fields = [
        "CLM_SubscriberName_L2100_NM1",
        "CLM_PatientName_L2100_NM1",
        # Contact_Name removed - these are EDI/technical contacts, not patient PII
    ]

    address_fields = []

    id_fields = ["CLM_MemberID_L2100_NM1", "CLM_SSN_L2100_NM1"]
